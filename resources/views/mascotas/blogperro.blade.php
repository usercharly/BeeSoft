					...
					<div class="row">
						<div class="col-lg-8 posts-list">
							...
							<div class="comment-form">
								...
								<form  method="post" action="{{route('postear',$mascota->id)}}" enctype="multipart/form-data" data-parsley-validate>
									{{ csrf_field() }}
									...
									<div class="form-group">
										<input type="text" class="form-control" id="asunto" name="asunto" placeholder="Asunto" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Subject'" required="true" data-parsley-maxlength="20">
									</div>
									<div class="form-group">
