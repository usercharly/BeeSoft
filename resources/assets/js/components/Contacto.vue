            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Peticiones-Contactos
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="contacto in arrayContacto" :key="contacto.id">
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm" @click="desactivarCont(contacto.id)">
                                    ...
                                    <td v-text="contacto.descripcion"></td>
                                    <th v-text="contacto.fecha"></th>
                                </tr>                                
                            </tbody>
                        </table>
                        <nav>
    ...
    export default {
        ...
        methods : {
            listarPersona (page,buscar,criterio){
                let me=this;
                var url= '/contactos?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            cerrarModal(){
               ...
               swal({
                title: 'Desea Eliminar el Mensaje de Contacto?',
                type: 'warning',
