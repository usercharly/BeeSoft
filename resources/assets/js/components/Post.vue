            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Post-Comentarios
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="post in arrayPost" :key="post.id">
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm" @click="desactivarPost(post.id)">
                                                    <i class="icon-trash"></i>
                                                </button>
                                    </td>
                                    <td v-text="post.nombre"></td>
                                    <td v-text="post.email"></td>
                                    <td v-text="post.asunto"></td>
                                    <td v-text="post.mascota"></td>
                                </tr>                                
                            </tbody>
                        </table>
                        <nav>
    ...
    export default {
        ...
        methods : {
            listarPersona (page,buscar,criterio){
                let me=this;
                var url= '/post?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arrayPost = respuesta.posts.data;
